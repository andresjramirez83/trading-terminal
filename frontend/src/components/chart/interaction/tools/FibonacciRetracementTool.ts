// src/components/chart/interaction/tools/FibonacciRetracementTool.ts
...
export class FibonacciRetracementTool implements ChartTool {
  readonly id = "fibonacci";
  readonly label = "Fibonacci Retracement";
  ...
  onClick(event: ChartMouseEvent, context: ToolContext): boolean | void {
    ...
    const created = this.drawingEngine.createFibonacciFromPoints(
      start,
      end,
      this.getStyle(),
    );
