// src/components/chart/interaction/tools/RectangleTool.ts
...
export class RectangleTool implements ChartTool {
  ...
  onClick(event: ChartMouseEvent, context: ToolContext): boolean | void {
    ...
    const created = this.drawingEngine.createRectangleFromPoints(
      start,
      end,
      this.getStyle(),
    );
