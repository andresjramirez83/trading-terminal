...
const CHART_LINE_VISIBILITY_STORAGE_KEY = "trading-terminal.chart.lineVisibility.v5.defaultOn";

const DEFAULT_LINE_VISIBILITY: LineVisibilityState = {
  // IMPORTANT:
  // Page-level Studies toggle is the source of truth.
  // This internal layer must default ON so old localStorage cannot silently
  // hide studies like projections, trendlines, and session bands after updates.
  pmh: true,
  vwap: true,
  compression: true,
  choch: true,
